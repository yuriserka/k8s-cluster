...
public class WeatherControllerAdvice extends CommonRestAdvice {

  @ExceptionHandler(ForecastInformationNotFoundException.class)
  @ResponseStatus(HttpStatus.NOT_FOUND)
  public ExceptionDto handleForecastInfoNotFoundException(
      final ForecastInformationNotFoundException e
  ) {
  ...
  public ExceptionDto handleFailToEncodeCityNameException(
      final FailToEncodeCityNameException e
  ) {
  ...
  @ResponseStatus(HttpStatus.NOT_FOUND)
  public ExceptionDto handleGeoInformationNotFoundException(
      final GeoInformationNotFoundException e
  ) {
